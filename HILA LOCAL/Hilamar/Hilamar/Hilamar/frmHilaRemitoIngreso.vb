...
Public Class frmHilaRemitoIngreso
    ...
    Private Sub Guardar()
        ...
        If UltimoRemitoIngreso = "" Then
            MensajeAtencion("No se pudo obtener el último nro de Remito de Ingreso. No se grabará el Movimiento. Verifique.")
            Exit Sub
        End If
        ...
        sStr = sStr + "VALUES "
        sStr = sStr + "('" + UltimoRemitoIngreso + "','" + Format(dtpFecha.Value, "yyyyMMdd") + "','I',getdate(),'" + txtObservacion.Text + "')"
        Command = New SqlCommand(sStr, cConexionApp.SQLConn)
        ...
        For i = 0 To dgvDetalleRemito.RowCount - 1
            If dgvDetalleRemito.Rows(i).Cells("Kilos").Value > 0 Then
                ...
                sStr = sStr + "VALUES "
                sStr = sStr + "('I', '" + UltimoRemitoIngreso + "','"
        ...
        MensajeInfo("Se ha registrado correctamente el remito de Ingreso de Hilados.")
        Cargar()
    ...
    Private Sub agregar_linea_al_detalle()
        ...
        If txtKilos.Text <> "" Then
            If IsNumeric(txtKilos.Text) Then
                ...
                Else
                    row = {txtPartida.Text, txtHilado.Text, txtColor.Text, txtKilos.Text, txtDetObservacion.Text}
...
ErrCodHiladoyHiladoyColordeUnaPartida:
    ...
    Private Sub txtDetObservacion_TextChanged(sender As Object, e As EventArgs) Handles txtDetObservacion.TextChanged
